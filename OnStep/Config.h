// ---------------------------------------------------------------------------------------------------------------------------------
// Configuration for OnStep för MKS Gen-L 2.0 and Bigtreetek TMC 5160 V 1.2 (CNC 400)
// WIKI Version: https://onstep.groups.io/g/main/wiki/3996 (Revision 149 from May 22, 2021)
...
#define PINMAP                   MksGenL2 //    OFF, Choose from: MksGenL2, MiniPCB2, MaxPCB2, MaxESP3, CNC3, STM32Blue,     <-Req'd
...
#define AXIS1_DRIVER_STATUS           ON  //    OFF, TMC_SPI, HIGH, or LOW.  Polling for driver status info/fault detection.  Option
...
#define AXIS2_DRIVER_STATUS           ON  //    OFF, TMC_SPI, HIGH, or LOW.  Polling for driver status info/fault detection.  Option
