...
#define PINMAP                      MksGenL1 //    OFF, Choose from: MiniPCB, MiniPCB2, MaxPCB, MaxPCB2, STM32Blue,             <-Req'd
...
// for the next an MKS-GEN L v 1.0 see: https://onstep.groups.io/g/main/topic/avoid_reset_on_connect_for/74216100# 
// Avoid reset on connect for MKS Gen L and allow simultaneous wifi and USB connections 
#define SERIAL_C_BAUD_DEFAULT        19200 //    OFF, ON for ESP32 Bluetooth.                                                 Option
                                           // To get an initial connection, set to  9600 
                                           // after init, set to  19200 for MKS-Gen 1.0 because of problems with the handy app
...
#define LED_RETICLE                   200 //    OFF, n. Where n=0..255 (0..100%) activates feature sets default brightness.   Option
...
#define TRACK_BACKLASH_RATE           10 //     25, n. Where n=2..50 (x sidereal rate) during backlash takeup.               Option
                                          //         Too fast motors stall/gears slam or too slow and sluggish in backlash.

// SLEWING BEHAVIOUR ---------------------------------------------- see https://onstep.groups.io/g/main/wiki/6-Configuration#SLEWING
#define SLEW_RATE_BASE_DESIRED        2.2 //    1.0, n. Desired slew rate in deg/sec. Adjustable at run-time from            <-Req'd
...
#define AXIS1_STEPS_PER_DEGREE    40960.0 //  12800, n. Number of steps per degree:                                          <-Req'd
...
#define AXIS1_DRIVER_IGOTO            3000 //    OFF, n, (mA.) Current during slews. OFF uses same as IRUN.                    Option
...
#define AXIS2_STEPS_PER_DEGREE    40960.0 //  12800, n. Number of steps per degree:                                          <-Req'd
                                          //         n = (stepper_steps * micro_steps * overall_gear_reduction)/360.0
...
#define AXIS2_DRIVER_IGOTO            3000 //    OFF, n, (mA.) Current during slews. OFF uses same as IRUN.                    Option
...
#define AXIS4_STEPS_PER_MICRON        1 //    0.5, n. Steps per micrometer. Figure this out by testing or other means.      Adjust
...
#define AXIS4_LIMIT_MIN_RATE           20 //     50, n. Where n=1..1000 (um/s.) Minimum microns/second. In DC mode, min pwr.  Adjust
#define AXIS4_LIMIT_MIN                 0 //      0, n. Where n=0..500 (millimeters.) Minimum allowed position.               Adjust
#define AXIS4_LIMIT_MAX                500 //     50, n. Where n=0..500 (millimeters.) Maximum allowed position.               Adjust

// AXIS5 FOCUSER 2
// see https://onstep.groups.io/g/main/wiki/6-Configuration#AXIS5
#define FOCUSER2                      ON //    OFF, ON to enable this focuser.                                               Option
#define AXIS5_STEPS_PER_MICRON        1 //    0.5, n. Steps per micrometer. Figure this out by testing or other means.      Adjust
...
#define AXIS5_LIMIT_MIN_RATE           100 //     50, n. Where n=1..1000 (um/s.) Minimum microns/second. In DC mode, min pwr.  Adjust
#define AXIS5_LIMIT_MIN                 0  //      0, n. Where n=0..500 (millimeters.) Minimum allowed position.               Adjust
#define AXIS5_LIMIT_MAX                250 //     50, n. Where n=0..500 (millimeters.) Maximum allowed position.               Adjust
