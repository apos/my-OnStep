...
#define SERIAL_C_BAUD_DEFAULT        19200 //    was 9600 before fix , OFF, n, ON for ESP32 Bluetooth.                        Option
...
#define AXIS1_STEPS_PER_DEGREE    20480.0 //  12800, n. Number of steps per degree:                                          <-Req'd
...
#define AXIS2_LIMIT_MIN               0 //    -90, n. Where n=-90..0 (degrees.) Minimum allowed declination.                Infreq
#define AXIS2_LIMIT_MAX               0 //     90, n. Where n=0..90 (degrees.) Maximum allowed declination.                 Infreq
