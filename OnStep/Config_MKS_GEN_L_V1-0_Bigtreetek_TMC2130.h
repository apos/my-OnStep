...
// ONSTEP MKS-L-GEN Board Vers. 1.0 for CNC-400 and BigtreeTek TMC-2130 SPI
...
#define AXIS1_DRIVER_STATUS           TMC_SPI //    OFF, ON Enables polling for driver status info/fault detection.               Option
...
#define AXIS2_DRIVER_STATUS           TMC_SPI //    OFF, ON Enables polling for driver status info/fault detection.               Option
